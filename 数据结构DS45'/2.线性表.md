...
线性表是具有**相同数据类型**的n (n≥0）个数据元素的**有限序列**，其中n为**表长**，当n=0时线性表是一个**空表**。
若用L命名线性表，则其一般表示为：
L = (a1, a2,..., ai, ai+1,..., an)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/377216ca8d544f6098876872fb360c68.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/3581980e021a4527a9b249475b8e18dd.png)
